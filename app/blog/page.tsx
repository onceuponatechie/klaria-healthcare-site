          ...
          <Link href={`/blog/${featured.slug}`}>
            ...
            >
              <div className="lg:col-span-7 aspect-[16/10] rounded-2xl overflow-hidden">
                <motion.img src={featured.img.src} alt={featured.title} loading="lazy" className="w-full h-full object-cover" whileHover={{ scale: 1.05 }} transition={{ duration: 0.7 }} />
              </div>
              ...
              <Link href={`/blog/${p.slug}`}>
                <motion.article whileHover={{ y: -6 }} className="group h-full rounded-3xl bg-card border border-border overflow-hidden shadow-soft hover:shadow-glass transition-shadow">
                  <div className="aspect-[16/10] overflow-hidden">
                    <motion.img src={p.img.src} alt={p.title} loading="lazy" className="w-full h-full object-cover" whileHover={{ scale: 1.06 }} transition={{ duration: 0.7 }} />
                  </div>
